...
declare module "@prismicio/client" {
  interface PageDocument extends Content.PrismicDocument {
    data: {
      uid: string;
      meta_title: Content.KeyTextField;
      meta_description: Content.KeyTextField;
      meta_image: Content.ImageField;
      slices: Content.SliceZone;
    };
  }
}
...
type PageDocumentDataSlices1Slice = InformationSliceSlice;
